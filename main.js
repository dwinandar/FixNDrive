...
if (user === 'login') {
  ...
  <a href="/"><img src="${window.origin}/assets/Logo.svg" alt="logo-fixndrive" /></a>
  <div>
  ...
  <ul>
    ...
    <li>
      <div class="service-wrap">
        <span class="dropbtn ${path === '/carcare.html' ? 'active-nav' : path === '/motorcare.html' ? 'active-nav' : path === '/schedule.html' ? 'active-nav' : ''}">Layanan</span>
    ...
    <li><a href="/forum.html" class=${path === '/forum.html' ? 'active-nav' : ''}>Forum</a></li>
    <li><a href="/contact.html" class=${path === '/contact.html' ? 'active-nav' : ''}>Kontak</a></li>
  </ul>
  <div class="profile-nav">
    <a href="/notif.html"
      ><img src="${window.origin}/assets/notif-icon.svg" alt="notif-icon" class=${path === '/notif.html' ? 'active-nav' : ''}
    /></a>
  ...
  if (navbar) {
    ...
    <ul>
      ...
      <li>
        <div class="service-wrap">
        <span class="dropbtn ${path === '/carcare.html' ? 'active-nav' : path === '/motorcare.html' ? 'active-nav' : ''}">Layanan</span>
          <img src="${window.origin}/assets/arrow-down.svg" alt="arrow-down-icon" />
          <ul class="service-dropdown" id="service-dropdown">
            <li><a href="/carcare.html">Perawatan Mobil</a></li>
            <li><a href="/motorcare.html">Perawatan Motor</a></li>
